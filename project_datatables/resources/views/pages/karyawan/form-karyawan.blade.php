                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="no_telp"  placeholder="Masukan nomer telp anda" name="no_telp" value="{{ old('no_telp') }}">
                                    @error('no_telp')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="datepicker">
                                        <input type="date" class="form-control datetimepicker-input" name="tgl_lahir" value="{{ old('tgl_lahir') }}">
                                    </div>
                                    @error('tgl_lahir')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="status_id" id="status_id" class="form-control">
                                        @foreach($status as $tampil)
                                            <option value="{{$tampil->id}}" {{old('status_id') == "$tampil->status" ? 'selected' : ''}}>{{ $tampil->status }}
                                            </option>
                                        @endforeach
                                    </select>
                                    @error('status_id')
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="jabatan_id" id="jabatan_id" class="form-control">
                                        @foreach($jabatan as $tampil)
                                            <option value="{{$tampil->id}}" {{old('jabatan_id') == "$tampil->nama_jabatan" ? 'selected' : ''}}>{{ $tampil->nama_jabatan }}
                                            </option>
                                        @endforeach
                                    </select>
                                    @error('jabatan_id')
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="pendidikan_id" id="pendidikan_id" class="form-control">
                                        @foreach($pendidikan as $tampil)
                                            <option value="{{$tampil->id}}" {{old('pendidikan_id') == "$tampil->pendidikan" ? 'selected' : ''}}>{{ $tampil->pendidikan }}
                                            </option>
                                        @endforeach
                                    </select>
                                    @error('pendidikan_id')
